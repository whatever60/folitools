...
def test_simplify_gene_list_basic_cases():
    ...
    cases = [
        ...
        ("DEFA1|DEFA3|DEFA1B", "DEFA1|DEFA3|DEFA1B"),
    ...
    for input_str, expected in cases:
        result = simplify_gene_list(input_str)
        assert result == expected, f"Input: {input_str} → Got: {result!r}, Expected: {expected!r}"
...
def test_empty_and_edge_cases():
    ...
    # Whitespace handling
    assert simplify_gene_list(" GENE1 | GENE2 ") == "GENE1|GENE2"
